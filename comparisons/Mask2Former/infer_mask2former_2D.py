"""
2D Inference script for Mask2Former.
"""
...
def load_model(checkpoint_path, device):
    from train_mask2former import Mask2FormerSimplified
...
def main():
    parser = argparse.ArgumentParser(description='2D inference with Mask2Former')
    ...
    parser.add_argument('--save_overlay', action='store_true', help='Save overlay')
